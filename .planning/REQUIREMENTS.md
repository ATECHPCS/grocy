...
- [ ] **DATA-03**: *(RE-PLANNED 2026-09-12, in progress)* Maintainer can audit the conversion set: 62 global + 18 product-specific across 9 products, every product-specific row a legitimate package-size definition. 06-06 ships a classifying read-only audit that records this baseline and closes DATA-03 by verification (no cleanup targets — the 18 are intentional).
- [ ] **DATA-04**: *(RE-PLANNED 2026-09-12, in progress)* A read-only integrity tripwire fails the audit if a SUSPICIOUS product-specific conversion appears (orphaned product_id; non-positive/non-finite factor; neither side the product's stock/purchase unit; exact global-duplicate). Legitimate package definitions do not trip it.
- [ ] **DATA-05**: *(RE-PLANNED 2026-09-12, in progress)* No redundant product-specific conversions exist on current data (0 exact global-duplicates); no deletion code built. The audit flags a future exact-duplicate as SUSPICIOUS rather than removing anything.
...
| DATA-03 | Phase 6 | Re-planned 2026-09-12 — 06-06 classifying audit (in progress) |
| DATA-04 | Phase 6 | Re-planned 2026-09-12 — integrity tripwire (in progress) |
| DATA-05 | Phase 6 | Re-planned 2026-09-12 — 0 duplicates; flag-not-delete (in progress) |
