...
| 04-04-01 | 04 | 4 | CONV-02, CONV-04, CONV-06 | T-04-04 | Fast fixture/DOM coverage proves candidate revisions reject stale responses and disable Save through pending, inactive-gate, blocked, and request-failure states; Playwright retains native form integration coverage for normal product-scoped Save and inactive reusable messaging | DOM/browser | `node --test public/custom/grocy_AI/conversion-explanations.test.js && npm --prefix custom/grocy_AI/tests/browser test -- --grep @conv04` | ❌ W0 | ⬜ pending |
