...
| 04-05-01 | 05 | 5 | CONV-04, CONV-05 | T-04-05 | Product screen exposes source/provenance without writes | DOM/browser | `node --test public/custom/grocy_AI/conversion-explanations.test.js && npm --prefix custom/grocy_AI/tests/browser test -- --grep @conv04` | ❌ W0 | ⬜ pending |
| 04-06-01 | 06 | 6 | CONV-05, CONV-07 | T-04-06 | Resolved table exposes bounded provenance while preserving native behavior | DOM/browser | `node --test public/custom/grocy_AI/conversion-explanations.test.js && npm --prefix custom/grocy_AI/tests/browser test -- --grep @conv04` | ❌ W0 | ⬜ pending |
| 04-07-01 | 07 | 7 | CONV-07 | T-04-16 | Coverage/CLI diagnostics are aggregate, redacted, read-only, and cannot activate rules | integration/DOM | `php custom/grocy_AI/tests/run.php conversion-coverage && php custom/grocy_AI/tests/run.php conversion-readonly-cli && node --test public/custom/grocy_AI/conversion-coverage.test.js` | ❌ W0 | ⬜ pending |
| 04-08-01 | 08 | 8 | CONV-02, CONV-03, CONV-05, CONV-08, CONV-09 | T-04-18 | Only immutable dual-branch evidence can activate selected reusable native/cache projection; all protected consumer outputs remain equivalent | integration/release | `php custom/grocy_AI/tests/run.php conversion-release-gate && bash custom/grocy_AI/tests/release-gate.sh conversions` | ❌ W0 | ⬜ pending |
